...
def test_backup_counts_as_eight_hours():
    assert billable_shift_hours("Backup 6a-6a", "Backup", 8.0) == 8.0
...
def test_pay_period_aggregation_uses_backup_and_cleanup_hours():
    df = pd.DataFrame([
        ...
        {"person": "Fadial", "pp": "2026 PP01", "pp_start": date(2026, 1, 4), "pp_end": date(2026, 1, 17), "shift_count": 1, "included_hours": 8.0, "backup_count": 1, "weekend": 0, "night": 0},
    ])
